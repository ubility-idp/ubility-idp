...
broker_heartbeat = 0
task_annotations = {'routes.terraform_apis.terraform_run': {'time_limit': 10000.0},
                    'routes.terraform_apis.terraform_delete':{'time_limit': 10000.0},
                    'routes.ansible_apis.ansible_run':{'time_limit': 10000.0},
                    'routes.run_code_apis.run_code':{'time_limit': 10000.0}}
...
imports = ('routes.terraform_apis','routes.ansible_apis','routes.run_code_apis')
